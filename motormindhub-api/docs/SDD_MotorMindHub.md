...
| GestioneUtenti                | registerUser, authenticate       | ↑ + updateProfile, requestAccountDataExport, requestAccountDeletion, reportUser | ↑ (eredita Iscritto)                                                                                                  | ↑ (eredita Autore)                                                                                                   | getUserManagementDashboard, searchUsers, suspendAccount, reactivateAccount, getReportsQueue, resolveReport, getDeletionRequestsQueue, processAccountDeletion, exportUserDataAssisted, getAdministrativeActionLog |
